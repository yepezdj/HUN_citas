...
let getConciliator = (req, res) => {
    if (req.session.conciliator) {
        ...
        DATE_FORMAT(agendamiento.fecha, "%Y-%m-%d") fecha, DATE_FORMAT(agendamiento.fecha_nac, "%Y-%m-%d") fecha_nac, agendamiento.hora_ini, agendamiento.Cita, agendamiento.Modo, agendamiento.Afiliacion, agendamiento.Orden, agendamiento.Tipo_documento, agendamiento.Descripcion, agendamiento.Estado_civil, agendamiento.Genero,
